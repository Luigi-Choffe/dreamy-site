...
export const TEAM: TeamSeat[] = [
  ...
  },
  {
    ...
    motivo: "Lista ruim derruba a entregabilidade; o THAO protege o funil na porta de entrada.",
    hired: true,
    kinds: ["leads"],
  },
  {
    ...
    motivo: "Interessado sem resposta esfria em horas; o TAY existe para isso nunca acontecer.",
    hired: true,
    kinds: ["resposta"],
  },
  {
