...
| T2  | **Tabela da casa** | Componente/anatomia padrão de tabela (leis 1–2) e migração das tabelas de Contatos, Atividade, Supressão e Campanha para ele.                                        | estreou · 2026-09-01 (Contatos+Supressão; Atividade/Campanha migram em R8/R10) |
...
| --- | ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------ |
| R1  | **Hoje**               | Ações "+1d (02/09) · +3d (04/09) · semana (08/09)" parecem texto solto e se repetem idênticas em toda linha; colunas da linha não se ancoram.                                                      | Linha em 3 zonas com grid fixo; "Concluir" como ação primária e **um** menu compacto "adiar ▾" (datas dentro); data da tarefa alinhada em coluna própria.                                                                            | a fazer            |
