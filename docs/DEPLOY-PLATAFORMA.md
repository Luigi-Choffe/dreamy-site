...
| `OUTBOUND_REPLY_TO`                                                   | o mesmo do `.env.local` (caixas que recebem respostas, separadas por vírgula)      | o primeiro endereço vale para `List-Unsubscribe` e para a UI; o Resend recebe todos    |
