...
- **Aquário (2026-08-30)**: organograma vivo do time em lente de vidro 9:19, fixo à direita do console em telas largas (e na aba MORK nas demais): MORK no topo, 5 cadeiras (vaga = cadeira tracejada), ficha por hover/foco com função, motivo e tarefa atual derivada das demandas (src/lib/outbound/team.ts, src/app/interno/outbound/aquario.tsx) e resumo das últimas atividades no pé do tanque.
