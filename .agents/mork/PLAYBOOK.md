...
| Time de agentes (subagentes do MORK)   | `.claude/agents/` (slugs internos estáveis): NIX=verbo (copy), KAI=garimpo (leads/ICP), TAY=trato (respostas/CRM), ZED=forja (plataforma) — nomes públicos curtos desde 2026-09-02; 5ª vaga MIRA reservada; demitir só com permissão do Luigi |
